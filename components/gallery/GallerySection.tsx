  ...
  return (
    <section className="bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-20 space-y-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-12 mt-10">
          {/* Images Section */}
          <div className="hidden md:flex items-end gap-3 sm:gap-4 md:gap-6 w-full lg:w-auto">
            ...
            <div className="relative w-full sm:w-[280px] md:w-[350px] lg:w-[420px] xl:w-[500px] h-[200px] sm:h-[250px] md:h-[320px] lg:h-[420px] xl:h-[500px] overflow-hidden group">
              ...
              />
              <button className="absolute bottom-3 sm:bottom-4 md:bottom-6 left-3 sm:left-4 md:left-6 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-yellow-400 rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300">
