    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-12">
          ...
          {/* Images Section - Hidden on small screens, visible from md onwards */}
          ...
          <div className="relative grid grid-cols-1 min-h-[300px] sm:min-h-[350px] lg:min-h-[420px] w-full lg:w-auto lg:max-w-md xl:max-w-lg">
            ...
            <div className="md:self-start">
              ...
              <h1
                className={`${raleway.className} text-xl sm:text-2xl md:text-3xl lg:text-4xl uppercase font-semibold leading-tight sm:leading-normal`}
              >
                LET'S KEEP IN TOUCH
              </h1>
            </div>

            {/* Contact Details - positioned at bottom with lines */}
            <div className="relative flex flex-col gap-4 sm:gap-6 lg:gap-8 md:self-end w-full">
              
              {/* Phone */}
              <div className="flex flex-col gap-1.5 sm:gap-2">
                <div className="flex justify-between items-end gap-4">
                  <span className="text-xs sm:text-sm md:text-base text-gray-600 whitespace-nowrap">PHONE</span>
              ...
              <div className="flex flex-col gap-1.5 sm:gap-2">
                <div className="flex justify-between items-end gap-4">
                  <span className="text-xs sm:text-sm md:text-base text-gray-600 whitespace-nowrap">EMAIL</span>
              ...
              <div className="flex flex-col gap-1.5 sm:gap-2">
                <div className="flex justify-between items-end gap-4">
                  <span className="text-xs sm:text-sm md:text-base text-gray-600 whitespace-nowrap">LOCATION</span>
                  <span className="font-semibold text-xs sm:text-sm md:text-base text-right">
