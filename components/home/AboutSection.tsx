      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="">
            ...
            <div className={`${raleway.className} space-y-2`}>
              <h1
              ...
              <h1
                className={`font-semibold text-xl sm:text-2xl lg:text-3xl leading-relaxed tracking-normal text-justify`}
              >
                Founded in 2076 B.S., Quick S and A Construction Pvt. Ltd. has
                grown from its roots in Kathmandu into a respected name across
                Nepal. With a focus on innovation, quality, and sustainability,
                every project we deliver contributes to Nepal’s progress.
              </h1>
            </div>

            <div className="flex flex-row justify-between items-center mt-4 sm:mt-0 gap-4 sm:gap-6">
              <div className="w-full sm:w-80 md:w-90 h-0.5 bg-gray-800"></div>
              <a
                href="tel:+9779851149961"
                className="hover:scale-95 duration-200 flex items-center justify-center gap-2 rounded-xl bg-sky-700 px-3 py-2 sm:px-4 md:px-5 text-white  hover:bg-sky-800 transition w-full sm:w-auto text-base whitespace-nowrap"
              >
                <PhoneCall size={18} className="w-4 h-4 sm:w-5 sm:h-5" />
                +977-9851149961
              </a>
            </div>
          </div>
